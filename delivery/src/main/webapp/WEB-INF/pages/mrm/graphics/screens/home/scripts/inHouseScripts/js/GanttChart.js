    ...
    Grids.OnGetGanttHtml = function(G,row,col,width,comp,crit){
        switch(row.type){
            case "Marketing Initiative":
                ...
                return "<div style=\"background:#ffbc00;color:white;padding:2px; height: 11px; border:1px solid #ffbc00; border-radius: 4px;  box-shadow: 2px 2px 3px rgba(255, 255, 255, .9) inset; \"></div>";
            case "Campaign":
                Grids[0].SetValue(row,"nameIcon","cal2.png",1);
                return "<div style=\"background:#7971e2;color:white;padding:2px; height: 11px; border:1px solid #7971e2; border-radius: 4px;  box-shadow: 2px 2px 3px rgba(255, 255, 255, .9) inset\"></div>";
            case "SubCampaign":
                Grids[0].SetValue(row,"nameIcon","cal1.png",1);
                return "<div style=\"background:#ffbc00;color:white;padding:2px; height: 11px; border:1px solid #ffbc00; border-radius: 4px;  box-shadow: 2px 2px 3px rgba(255, 255, 255, .9) inset\"></div>";
            ...
            case "Communication Channel":
                Grids[0].SetValue(row,"nameIcon","cal2.png",1);
                return "<div style=\"background:mediumpurple;color:white;padding:2px; height: 11px; border:1px solid mediumpurple; border-radius: 4px;  box-shadow: 2px 2px 3px rgba(255, 255, 255, .9) inset\"></div>";
            default:
                return null;
        }
